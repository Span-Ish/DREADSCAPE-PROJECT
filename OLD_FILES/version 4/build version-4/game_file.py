...
backstory_bg = pygame.image.load(absolute_path + r'\assets\images\backstory.png').convert_alpha()
...
OM4 = pygame.image.load(absolute_path + r'\assets\images\OM4.png').convert_alpha()
OM4 = pygame.transform.scale(OM4,(120,60))
OM3 = pygame.image.load(absolute_path + r'\assets\images\OM3.png').convert_alpha()
OM3 = pygame.transform.scale(OM3,(100,50))
OM2 = pygame.image.load(absolute_path + r'\assets\images\OM2.png').convert_alpha()
OM2 = pygame.transform.scale(OM2,(100,50))
OM1 = pygame.image.load(absolute_path + r'\assets\images\OM1.png').convert_alpha()
OM1 = pygame.transform.scale(OM1,(100,50))
OM0 = pygame.image.load(absolute_path + r'\assets\images\OM0.png').convert_alpha()
...
LMB_indicator_pic = pygame.image.load(absolute_path + r'\assets\images\LMB_indicator.png').convert_alpha()
...
darken = pygame.image.load(absolute_path + r'\assets\images\darken.png').convert_alpha()
...
def main_gameLoop():
    ...
    def main_view():
        ...
        oxygen_text = octosquares3.render('OXYGEN',True,'white')
        if fadeScreen.fade_flag:
            fade_run = True
            alpha = 180
            while fade_run:
                ...
                screen.blit(oxygen_text,(575,205))
                fade_img.set_alpha(alpha)
                screen.blit(fade_img,(0,0))
                pygame.display.update()
                pygame.time.delay(fadeScreen.time_delay)
...
* FIX THE SONAR SCREEN SO THAT IT CAN ALWAYS BE ACTIVATED AND IT ONLY SHOWS ITS OFFLINE WHEN YOU DONT CLICK ANYTHING
