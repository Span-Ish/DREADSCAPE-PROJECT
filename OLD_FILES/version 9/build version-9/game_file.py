...
indicator_dict = {'mainD':True,'mainA':True,'mainS':True,'tabletW':True,'tabletA':True,'mapW':True,'mapD':True,'noticeD':True,'NOTICE_ESCAPE':True,'cameraA':True,'SONAR_ESCAPE':True,'LOGS_ESCAPE':True,'sonarLMB':True,'noticeboardLMB':True}
...
rv_crash = pygame.mixer.Sound(absolute_path + r'\assets\audio\rover_crash.wav')
fall_crash = pygame.mixer.Sound(absolute_path + r'\assets\audio\fall_crash.wav')
fall_crash.set_volume(0.2)
...
class POI_Marker:
    ...
    def hover_event(self):
        mouse_pos = pygame.mouse.get_pos()
        button_rect = button_rect = pygame.rect.Rect((self.x_pos,self.y_pos),(30,30))
...
def main_gameLoop():
    ...
    def map_view():
        ...
        while map_view_var:
            ...
            poi1 = POI_Marker(300,105,POI_DICT['1'],lights_check_status)
            poi2 = POI_Marker(280,153,POI_DICT['2'],lights_check_status)
            poi3 = POI_Marker(386,142,POI_DICT['3'],lights_check_status)
            poi4 = POI_Marker(366,214,POI_DICT['4'],lights_check_status)
            poi5 = POI_Marker(408,265,POI_DICT['5'],lights_check_status)
            poi6 = POI_Marker(440,303,POI_DICT['6'],lights_check_status)
            poi7 = POI_Marker(513,304,POI_DICT['7'],lights_check_status)
            poi8 = POI_Marker(486,372,POI_DICT['8'],lights_check_status)
            poi9 = POI_Marker(677,342,POI_DICT['9'],lights_check_status)
            poi10 = POI_Marker(654,400,POI_DICT['10'],lights_check_status)
            poi11 = POI_Marker(804,410,True,lights_check_status)
            poi12 = POI_Marker(958,495,True,lights_check_status)
            poi13 = POI_Marker(915,267,True,lights_check_status)
            poi14 = POI_Marker(696,226,True,lights_check_status)
            poi15 = POI_Marker(764,153,True,lights_check_status)
            poi16 = POI_Marker(484,124,True,lights_check_status)
            ...
            if poi1.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 1920m','Y = 930m','z = 92m',poi1.x_pos,poi1.y_pos
                poi_hover = True
            elif poi2.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 1680m','Y = 1680m','z = 96m',poi2.x_pos,poi2.y_pos
                poi_hover = True
            elif poi3.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 2930m','Y = 1745m','z = 108m',poi3.x_pos,poi3.y_pos
                poi_hover = True
            elif poi4.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 2750m','Y = 3475m','z = 110m',poi4.x_pos,poi4.y_pos
                poi_hover = True
            elif poi5.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 3150m','Y = 4611m','z = 124m',poi5.x_pos,poi5.y_pos
                poi_hover = True
            elif poi6.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 3550m','Y = 5175m','z = 131m',poi6.x_pos,poi6.y_pos
                poi_hover = True
            elif poi7.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 5250m','Y = 3750m','z = 151m',poi7.x_pos,poi7.y_pos
                poi_hover = True
            elif poi8.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 4650m','Y = 5115m','z = 168m',poi8.x_pos,poi8.y_pos
                poi_hover = True
            elif poi9.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 7150m','Y = 4850m','z = 193m',poi9.x_pos,poi9.y_pos
                poi_hover = True
            elif poi10.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 6450m','Y = 5775m','z = 208m',poi10.x_pos,poi10.y_pos
                poi_hover = True
            elif poi11.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 8450m','Y = 5700m','z = 215m',poi11.x_pos,poi11.y_pos
                poi_hover = True
            elif poi12.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 10215m','Y = 7680m','z = 259m',poi12.x_pos,poi12.y_pos
                poi_hover = True
            elif poi13.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 9750m','Y = 5000m','z = 232m',poi13.x_pos,poi13.y_pos
                poi_hover = True
            elif poi14.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 7450m','Y = 3900m','z = 184m',poi14.x_pos,poi14.y_pos
                poi_hover = True
            elif poi15.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 8375m','Y = 2100m','z = 167m',poi15.x_pos,poi15.y_pos
                poi_hover = True
            elif poi16.hover_event():
                textx,texty,textz,poiX,poiY = 'X = 4125m','Y = 1250m','z = 108m',poi16.x_pos,poi16.y_pos
                poi_hover = True
            else:
                poi_hover = False
        ...
        while camera_var:
            ...
            if pygame.mouse.get_pressed()[0] and new_press:
                ...
                if test_button1.check_click():
                    ...
                    oxygen_meter = 3
                    battery_reset_event = True
                if test_button2.check_click():
                    battery_max = 4
                    oxygen_meter = 2
                    battery_reset_event = True
                if test_button3.check_click():
                    battery_max = 3
                    oxygen_meter = 1
                    battery_reset_event = True
                '''
            ...
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key in (pygame.K_LEFT,pygame.K_4,pygame.K_a) and pic_var in (0,80):
    ...
    def sonar_view():
        ...
        while sonar_view_run:
            ...
            player_newy = round(last_x+player_yUpdate,2) if player_yUpdate != -1 else '?'
            ...
            if not sonar_check_status:
                if screenshake:
                    if screenshake_timer == 15:
                        ...
                        screen.fill('#170200')
                        render_offset[0],render_offset[1] = random.randint(0,32) - 16,random.randint(0,32) - 16
    ...
    def power_screen():
        ...
        while power_run:
            ...
            wheels_check = powerButtons('WHEELS',650,240,(wheels_check_enabled and not cavefall_timer.active),wheels_check_status,64)
            sonar_check = powerButtons('SONAR',650,280,(sonar_check_enabled and not cavefall_timer.active),sonar_check_status,68)
    ...
    def comms_logs():
        ...
        while comms_logs_run_var:
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if tb_hover:
                        ...
                        if event.key == pygame.K_RETURN:
                            if len(user_text) == 5:
                                if user_text in ('199.8','211.4','139.9','152.5','167.0','426.6','92913') or (user_text == 208.3 and active_map not in (6,7)):
            ...
            if invalid_flag:
                screen.blit(invalid_text,(450,455))
            if load_var_flag:
                screen.blit(connecting_text,(420,455))
                if load_var == 80:
                    comms_logs_open()
                else:
                    load_var += 1
            screen.blit(comms_text,(455,50))
            tb_rect = pygame.rect.Rect((520,425),(100,25))
            pygame.draw.rect(base_comms_surface,(50,50,50),(515,420,110,35))
            pygame.draw.rect(base_comms_surface,(25,25,25),tb_rect)
            screen.blit(textbox_text,(540,425))
            screen.blit(khz_text,(635,425))
            if user_text == '':
                screen.blit(tutorial_text,(470,455))
    ...
    def comms_logs_open():
        global new_press, user_text,active_frequency, POI_DICT
        pygame.display.set_caption('Comms Logs Open')
...
* DESIGN THE FACILITY MAP (PHASE 5 LAST TASK)
...
START THE GAME FROM THE FIRST LEVEL, AND DO A CHECK ON EVERY MAJOR SYSTEM, LIST OR VARIABLES (POI_DICT,SCAN_DICT,EVENT_DICT,DATASCAN_DICT,OXYGEN_METER,BATTERY_MAX,MAP POSITIONS,POI MARKERS)
