...
def main_gameLoop():
    ...
    def map_view():
        ...
        while map_view_var:
            ...
            if poi1.hover_event():
                ...
                textx,texty,textz,poiX,poiY = 'X = 2750m','Y = 3050m','z = 110m',poi4.x_pos,poi4.y_pos
                poi_hover = True
    ...
    def game_over_screen():
        ...
        while True:
            ...
            if COD_dict['fin']:
                screen.blit(end_pic)
                if end_var == 140:
                    end_text = octosquares2.render('END.',True,'#5d0121')
                    screen.blit(end_text,(564,350))
                else:
                    end_var += 1
            for event in pygame.event.get():
    ...
    def power_screen():
        global new_press, wheels_check_status, sonar_check_status, ls_check_status, camera_check_status, scanner_check_status, lights_check_status,wheels_check_enabled, sonar_check_enabled, ls_check_enabled, camera_check_enabled, scanner_check_enabled, lights_check_enabled, battery_stack, battery_dict, battery_max, battery_reset_event, battery_change_after_event,endEvent_dict
        ls_start = False
            ...
            if active_frequency == '199.8':
                ...
                if alpha_val == 80:
                    ...
                    if active_page == 0:
                        ...
                        screen.blit(alien_lab_log)
                    elif active_page == 2:
                        screen.blit(alien_device_log)
                    elif active_page == 3:
                        screen.blit(alien_result_log)
                else:
                    alpha_val += 1
...
* (LONG) DRAW THE FACILITY PICTURE AND MONSTER PICTURE
...
ADD THE EVENT WHERE THE MONSTER FINDS YOU AND KILLS YOU (continue, event added, add the camera event where the picture is taken)
