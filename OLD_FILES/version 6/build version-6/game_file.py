...
player_maxSpeed,player_maxRotationSpeed = 2.0,0.015
...
main_view_bg_LO = pygame.transform.scale(main_view_bg_LO,(SCREEN_WIDTH,SCREEN_HEIGHT))
            ...
            if pygame.mouse.get_pressed()[0] and new_press:
                ...
                if camera_button.camcheck_Click():
                    if current_poi != 0:
                        ...
                        if POI_DICT['1'] == False and active_map == 1:
                            active_map = 2
                            player_maxSpeed,player_maxRotationSpeed = 2.5,0.02
        ...
        while sonar_view_run:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    elif event.key == pygame.K_w and not level1.player.move_forwardPressed and wheels_check_status:
                    ...
                    if event.key == pygame.K_s and not level1.player.move_backwardPressed and wheels_check_status:
            ...
            if active_map == 1:
                ...
                player_xUpdate,player_yUpdate = 528,288
            ...
            player_newx,player_newy = round(player_xDisplay_mod+player_xUpdate,2),round(player_yDisplay_mod+player_yUpdate,2)
