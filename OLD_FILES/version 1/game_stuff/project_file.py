...
def power_screen():
    global new_press
    global wheels_check_status
    global sonar_check_status
    global ls_check_status
    global camera_check_status
    global radio_check_status
    global lights_check_status
    global battery_stack
    ...
    while power_run:
        ...
        wheels_check = powerButtons('WHEELS',625,240,True,wheels_check_status,64)
        sonar_check = powerButtons('SONAR',625,280,True,sonar_check_status,68)
        ls_check = powerButtons('LIFE SUPPORT',625,320,True,ls_check_status,38)
        camera_check = powerButtons('CAMERA',625,360,True,camera_check_status,62)
        radio_check = powerButtons('RADIO',625,400,True,radio_check_status,70)
        lights_check = powerButtons('LIGHTS',625,440,True,lights_check_status,66)
